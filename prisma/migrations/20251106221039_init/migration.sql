-- CreateEnum
CREATE TYPE "LeadStatus" AS ENUM ('New', 'Contact', 'Qualified', 'Converted', 'Unresponsive', 'Desqualified', 'Archived');

-- CreateEnum
CREATE TYPE "LeadCampaignStatus" AS ENUM ('New', 'Engaged', 'FollowUp_Schedule', 'Contacted', 'Qualified', 'Converted', 'Unresponsive', 'Desqualified', 'Re_engaged', 'Opted_Out');
